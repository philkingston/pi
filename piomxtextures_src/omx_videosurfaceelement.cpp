...
QSGNode* OMX_VideoSurfaceElement::updatePaintNode(QSGNode* oldNode, UpdatePaintNodeData*)
{
   ...
   vertices[3].set(bounds.x(), bounds.y() + bounds.height(), 0.0f, 0.0f);
   vertices[2].set(bounds.x() + bounds.width(), bounds.y() + bounds.height(), 1.0f, 0.0f);
   vertices[1].set(bounds.x(), bounds.y(), 0.0f, 1.0f);
   vertices[0].set(bounds.x() + bounds.width(), bounds.y(), 1.0f, 1.0f);
   return node;
}
